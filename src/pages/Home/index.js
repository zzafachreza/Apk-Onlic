  ...
  <Image source={require('../../assets/logo.png')} style={{
    ...
    <View style={{padding:10, top:0, marginTop:20}}>
      ...
      <TouchableNativeFeedback onPress={() => navigation.navigate('Tumbuhanmu')}>
        <View style={{padding:10, borderWidth:2.5, borderRadius:20, borderColor:'#dededede',
          flexDirection:"row", justifyContent:'space-around', backgroundColor:'white'

        }}>
          <View style={{justifyContent:'center', alignItems:'flex-end'}}>

            <Text  style={{fontFamily:fonts.primary[700], fontSize:20, color:colors.primary, textAlign:"right"}}>DESAIN {'\n'}TUMBUHANMU</Text>
          </View>

          <View>
            <Image source={require('../../assets/tumbuhan.png')} style={{
              width:93, height:109
            }}/>
          </View>
        </View>
      ...
      <TouchableNativeFeedback onPress={() => navigation.navigate('Quiz')}>
        <View style={{padding:10, borderWidth:2.5, borderRadius:20, borderColor:'#dededede',
          ...
          <View style={{justifyContent:'center'}}>
            <Text  style={{fontFamily:fonts.primary[700], fontSize:20, color:colors.primary,
            textAlign:"right"}}>YUK COBA{'\n'}
            QUIZ MENARIK!</Text>
          </View>

          <View style={{right:20}}>
            <Image source={require('../../assets/quiz.png')} style={{
          ...
          <TouchableNativeFeedback onPress={() => navigation.navigate('Notes')}>
            <View style={{padding:10, borderWidth:2.5, borderRadius:20, borderColor:'#dededede',
              ...
              <View style={{justifyContent:'center', left:50}}>
                <Text  style={{fontFamily:fonts.primary[600], fontSize:20, color:colors.primary}}>MY NOTES</Text>
              </View>
    
              <View style={{right:30}}>
                <Image source={require('../../assets/note.png')} style={{
                  width:94, height:99
                }}/>
              </View>
            </View>
